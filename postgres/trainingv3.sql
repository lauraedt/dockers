...
ALTER TABLE OFICINA drop CONSTRAINT FK_OFICINA_DIRECTOR;
ALTER TABLE REPVENTA drop CONSTRAINT FK_REPVENTA_JEFE;
drop table pedido;
drop table producto;
drop table cliente;
drop table repventa;
...
--
-- Name: oficina; Type: ACL; Schema: public; Owner: postgres
--

/*
REVOKE ALL ON TABLE oficina FROM PUBLIC;
REVOKE ALL ON TABLE oficina FROM postgres;
GRANT ALL ON TABLE oficina TO postgres;
GRANT SELECT ON TABLE oficina TO PUBLIC;
*/
...
GRANT SELECT ON TABLE pedido TO PUBLIC;
*/
...
GRANT SELECT ON TABLE producto TO PUBLIC;
*/


--
-- Name: repventa; Type: ACL; Schema: public; Owner: postgres
--

/*
REVOKE ALL ON TABLE repventa FROM PUBLIC;
REVOKE ALL ON TABLE repventa FROM postgres;
GRANT ALL ON TABLE repventa TO postgres;
GRANT SELECT ON TABLE repventa TO PUBLIC;
*/
